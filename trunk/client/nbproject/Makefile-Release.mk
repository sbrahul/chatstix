...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/chatstixcli

dist/Release/GNU-Linux-x86/chatstixcli: ${OBJECTFILES}
...
${OBJECTDIR}/src/climain.o: nbproject/Makefile-${CND_CONF}.mk src/climain.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/climain.o src/climain.c
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/chatstixcli
